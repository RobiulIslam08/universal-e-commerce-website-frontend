...
// //     createPaymentIntent();
// //   }, [currentStep, paymentMethod, clientSecret, processing, currentUser, watch, grandTotal, cartItems, subtotal, shipping, tax]);
...
//         amount: grandTotal,
//         currency: "USD",
//         status: "succeeded", // অথবা "Paid" - আপনার ব্যাকএন্ড Enum অনুযায়ী
//         paymentMethod: "Card",
        
//         // Items Mapping
//         items: cartItems.map((item) => ({
//           productId: item.userId, // Product ID (backend এর সাথে মিল রেখে)
//           productName: item.name,
//           quantity: item.orderQuantity,
//           price: item.offerPrice || item.price,
//           image: item.image || "",
