  ...
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        ...
        { label: "Tops and Shirts", href: "#" },
        { label: "Women Jackets", href: "#" },
        { label: "Heels and Flats", href: "#" },
        { label: "Women Accessories", href: "#" },
      ],
    },
    {
      title: "For Him",
      links: [
        ...
        { label: "Men Shirts", href: "#" },
        { label: "Men Shoes", href: "#" },
        { label: "Men Accessories", href: "#" },
        { label: "Men Jackets", href: "#" },
      ],
    },
  ]
